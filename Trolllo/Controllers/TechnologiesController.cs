...
namespace Trolllo.Controllers
{
    public class TechnologiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TechnologyId,Name")] Technology technology)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TechnologyId,Name")] Technology technology)
        {
            if (ModelState.IsValid)
            {
